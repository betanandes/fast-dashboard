...
export default function DashboardPage() {
  ...
  const [porCategoria, setPorCategoria] = useState<
    Awaited<ReturnType<typeof buscarPorCategoria>>
  >([]);
      ...
      {kpis && kpis.count_vencidos > 0 && (
        <div className="flex items-start gap-3 p-4 bg-red-50 border border-red-100 rounded-xl">
          ...
          <p className="text-sm text-red-700">
            ...
            total de {fmtMoedaCompleto(kpis.total_vencido)}.
          </p>
        </div>
      )}
      {kpis && kpis.count_proximos7 > 0 && (
        <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-100 rounded-xl">
          ...
          <p className="text-sm text-amber-700">
            ...
            — {fmtMoedaCompleto(kpis.total_proximos7)} a pagar.
          </p>
        </div>
      )}
        ...
        <div className="card p-5 col-span-2">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={porMes} barSize={28}>
              ...
              />
              <Tooltip
                formatter={(v) => [fmtMoedaCompleto(Number(v ?? 0)), "Total"]}
        ...
        <div className="card p-5">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              ...
              <Legend
                formatter={(v: string) => v.substring(0, 20)}
                wrapperStyle={{ fontSize: 10 }}
              />
              <Tooltip
                formatter={(v) => [fmtMoedaCompleto(Number(v ?? 0)), ""]}
          ...
          <div className="space-y-3">
            {fornecedores.slice(0, 6).map((f, i) => (
              <div key={i} className="flex items-center gap-3">
                ...
                <span className="text-xs font-medium text-gray-900 w-16 text-right shrink-0">
        ...
        <div className="p-4 border-b border-gray-100 flex items-center gap-3 flex-wrap">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="input pl-8 w-48 text-xs py-1.5"
            />
          </div>
          <select
                ...
                {pagamentos.length === 0 ? (
                  ...
                  pagamentos.map((p) => (
                    ...
                    >
                      ...
                      <td
                        className="px-4 py-2.5 text-gray-900 max-w-[220px] truncate"
                        title={p.fornecedor}
                      >
                        {p.fornecedor}
                      </td>
